    ...
    >
      <div className="flex flex-col justify-center w-full h-full max-w-screen-lg p-4 mx-auto">
        ...
        <p className="mt-4 text-lg leading-relaxed sm:text-xl">
          I interned as a Backend Developer at Xceltech Solution, contributing to
          backend services for an HR Management System. Through the Africa to
          Silicon Valley program, I honed my skills in Flutter and teamwork.
          Additionally, I’ve solved 600+ problems on LeetCode and Codeforces,
          enhancing my problem-solving and algorithm expertise.
        </p>
      </div>
    </div>
  );
